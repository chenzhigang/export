...
import com.czg.export.demo.dao.UploadDAO;
import com.czg.export.demo.listener.*;
import com.czg.export.demo.vo.*;
...
public class EasyExcelReadUtil {
     ...
     * <p>3. 直接读即可
     */
    public void indexOrNameRead(String srcPath) {
        String fileName = srcPath + "demo" + File.separator + "demo.xlsx";
        // 这里默认读取第一个sheet
     ...
     * 3. 直接读即可
     */
    public void repeatedRead(String srcPath) {
        String fileName = srcPath + "demo" + File.separator + "demo.xlsx";
        // 读取全部sheet
        ...
        // 读取部分sheet
        fileName = srcPath + "demo" + File.separator + "demo.xlsx";
     ...
     * <p>3. 直接读即可
     */
    public void converterRead(String scrPath) {
        String fileName = scrPath + "demo" + File.separator + "demo.xlsx";
     ...
     */
    public void complexHeaderRead(String srcPath) {
        String fileName = srcPath + "demo" + File.separator + "demo.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet
     ...
     */
    public void synchronousRead(String srcPath) {
        String fileName = srcPath + "demo" + File.separator + "demo.xlsx";
     ...
     * 3. 直接读即可
     */
    public void headerRead(String srcPath) {
        String fileName = srcPath + "demo" + File.separator + "demo.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet
     ...
     * 3. 直接读即可
     */
    public void exceptionRead(String srcPath) {
        String fileName = srcPath + "demo" + File.separator + "demo.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet
     ...
     */
    public void noModleRead(String srcPath) {
        String fileName = srcPath + "demo" + File.separator + "demo.xlsx";
     ...
     * 3. 直接读即可
     */
    public String upload(MultipartFile file, UploadDAO uploadDAO) throws IOException {
